export default function Section4() {
  return (
    <div className="bg-gradient-to-b from-[#d1e8d0] to-[#a8d5ba]">
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-white/10 px-6 pt-16 sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-20 backdrop-blur-lg ring-1 ring-white/30 shadow-xl">
          ...
          >
            ...
            <defs>
              <radialGradient id="love-gradient">
                <stop stopColor="#9dc9b8" />
                <stop offset={1} stopColor="#bde0c8" />
              </radialGradient>
            </defs>
          </svg>
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-4xl font-bold tracking-tight text-[#2f3b2f] sm:text-5xl">
              ¡Te esperamos!
            </h2>
            <p className="mt-6 text-lg text-[#3f4b3f] leading-relaxed">
              ...
              <strong>Tu presencia será el mejor regalo que podamos recibir.</strong>
            </p>
          </div>
