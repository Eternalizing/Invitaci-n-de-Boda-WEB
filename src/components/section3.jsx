...
export default function Section3() {
  return (
    <div className="relative isolate overflow-hidden bg-gradient-to-r from-green-900 via-green-700 to-green-500 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold text-green-200">Nuestra historia</p>
              <h1 className="mt-2 text-5xl sm:text-6xl font-extrabold tracking-tight text-white">
                <span className="block text-6xl sm:text-7xl text-green-100">Leandro & Marli</span>
                <span className="block text-2xl sm:text-3xl text-green-200 mt-2 font-light">Cómo comenzó nuestro amor</span>
              </h1>
              <p className="mt-6 text-xl text-green-50/90">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base text-green-50/90 lg:max-w-lg">
              <p>
              ...
              <ul role="list" className="mt-8 space-y-8 text-green-50/90">
                <li className="flex gap-x-3">
                  <HeartIcon aria-hidden="true" className="mt-1 size-5 flex-none text-green-300" />
                  <span>
                ...
                <li className="flex gap-x-3">
                  <CalendarDaysIcon aria-hidden="true" className="mt-1 size-5 flex-none text-green-300" />
                  <span>
                ...
                <li className="flex gap-x-3">
                  <SparklesIcon aria-hidden="true" className="mt-1 size-5 flex-none text-green-300" />
                  <span>
